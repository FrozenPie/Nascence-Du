...
function of state — dissonance shortens it, calm lengthens it, boredom stretches it, night
slows everything — changed the system's character more than most organs did. Fewer, better
thoughts; real silence; sleep that means something. Volume is the easiest metric and the
wrongest one.
